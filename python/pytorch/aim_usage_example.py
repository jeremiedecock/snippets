...
for epoch in range(epochs):
    ...
    aim_run.track(train_loss, name='train_loss', step=epoch, context={ "subset": "train" })
    aim_run.track(test_loss, name='test_loss', step=epoch, context={ "subset": "test" })
    aim_run.track(test_accuracy, name='test_accuracy', step=epoch, context={ "subset": "test" })
