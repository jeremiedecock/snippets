...
HEADER_LIST = ["String column", "Int column", "Float column", "Boolean column"]
...
class MyData:
    def __init__(self):
        ...
        self._data = [["0", 0, 0.0, True] for i in range(self._num_rows)]   # <- the type of the data here define the delegate that is used : line edit for string, spinbox for int, doublespinbox for float, combobox for boolean
