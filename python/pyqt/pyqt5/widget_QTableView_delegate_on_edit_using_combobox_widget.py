...
from PyQt5.QtWidgets import QApplication, QTableView, QStyledItemDelegate, QComboBox

COMBO_BOX_ITEMS = ["Earth", "Mars", "Venus"]
...
class MyData:
    def __init__(self):
        ...
        self._data = [[COMBO_BOX_ITEMS[0] for j in range(self._num_columns)] for i in range(self._num_rows)]
