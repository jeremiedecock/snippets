...
from PyQt5.QtWidgets import QApplication, QTableView, QStyledItemDelegate, QDoubleSpinBox
...
class MyData:
    def __init__(self):
        ...
        self._data = [[0.0 for j in range(self._num_columns)] for i in range(self._num_rows)]
...
class MyDelegate(QStyledItemDelegate):
    ...
    def setEditorData(self, editor, index):
        value = float(index.data(Qt.EditRole))       # equivalent of    value = index.model().data(index, Qt.EditRole)
