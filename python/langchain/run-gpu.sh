...
podman run --rm -it -v hf-cache:/home/user/.cache/huggingface -v .:/workdir --userns=keep-id:uid=1000,gid=1000  --device nvidia.com/gpu=all  localhost/snippets-langchain:latest python3 "$@"
