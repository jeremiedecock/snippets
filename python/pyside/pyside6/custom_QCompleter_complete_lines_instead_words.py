...
class TextEdit(QPlainTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        self.setPlaceholderText('Try to type "planet " plus the name of a planet in our Solar System.')
        self._completer = QCompleter(self)

        self.model = QStringListModel()
        self.model.setStringList(sorted(["planet mercury", "planet venus", "planet earth", "planet mars", "planet jupiter", "planet saturn", "planet uranus", "planet neptune"]))  # The list of words to be autocompleted have to be sorted otherwise it won't work!
