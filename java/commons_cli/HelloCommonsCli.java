...
/*
 * This snippet tests the Commons CLI library.
 *
 * Usage:
 * - compile: javac -cp /usr/share/java/commons-cli.jar HelloCommonsCli.java
 * - execute: java -cp ./:/usr/share/java/commons-cli.jar HelloCommonsCli -h
 */
