...
See the replicas: `kubectl get pods -l app=hello`

Use it: `kubectl port-forward service/hello 8080:80` (then open
`http://localhost:8080`)
...
```
kubectl set image deployment/hello hello=docker.io/library/nginx:mainline-alpine-slim
kubectl rollout status deployment/hello
kubectl rollout undo deployment/hello   # roll back if needed
```
