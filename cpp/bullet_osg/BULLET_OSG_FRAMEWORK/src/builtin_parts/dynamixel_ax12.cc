...
simulator::Part * simulator::make_dynamixel_ax12() {
    ...
    p_part->jointSlotMap[std::string("slot1")] = p_robudog_joint_slot_1;
    p_part->jointSlotMap[std::string("slot2")] = p_robudog_joint_slot_2;

    //std::cout << "joint_slot_1 in builtin_parts : " << p_robudog_joint_slot_1 << std::endl;
